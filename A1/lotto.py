...
def number_generator():
    """Generate and sort 6 random number from lowest to highest in the range of [0, 49].
    POSTCONDITION: prints 6 randomly generated numbers in the range of [0, 49] from lowest to highest in a list"""
