...
def roll_die(number_of_rolls, number_of_sides):
    ...
    >>> random.seed(1) # Do not have to random.seed() at the end as it doesn't affect main function, only doctests
    >>> (roll_die(3, 6))
    8
    >>> (roll_die(0, 6))
    0
...
def choose_inventory(inventory, selection):
    ...
    You cannot have a negative selection!
    >>> choose_inventory(['sword', 'bow', 'axe'], 4)
    You cannot select more than your inventory size!
    >>> choose_inventory(['sword', 'bow', 'axe'], 3)
    ['sword', 'bow', 'axe']
    >>> choose_inventory(['sword', 'bow', 'axe'], 2)
    ['axe', 'sword']
...
def print_character(character):
    ...
    >>> print_character({'Name': 'Ajokixav', 'Class': 'bard', 'HP': 1, 'Strength': 12, 'Dexterity': 13, \
    'Constitution': 8, 'Intelligence': 10, 'Wisdom': 8, 'Charisma': 13, 'XP': 0})
    Name: Ajokixav
    Class: bard
    HP: 1
    Strength: 12
    ...
    XP: 0
    >>> print_character({'Name': 'Ajokixav', 'Class': 'bard', 'HP': 1, 'Strength': 12, 'Dexterity': 13, \
    'Constitution': 8, 'Intelligence': 10, 'Wisdom': 8, 'Charisma': 13, 'XP': 0, 'Inventory': ['bow', 'sword']})
    Name: Ajokixav
    Class: bard
    HP: 1
    Strength: 12
...
def combat_round(opponent_one, opponent_two):
    ...
    >>> random.seed(1)
    >>> combat_round({'Name': 'Jaki', 'Class': 'fighter', 'HP': 9, 'Strength': 18, 'Dexterity': 18, 'Constitution': 18,\
                        'Intelligence': 18, 'Wisdom': 18, 'Charisma': 18, 'XP': 0}\
                     , {'Name': 'Kurisu', 'Class': 'bard', 'HP': -2, 'Strength': 3, 'Dexterity': 3, 'Constitution': 3,\
                        'Intelligence': 3, 'Wisdom': 3, 'Charisma': 3, 'XP': 0})
    You rolled 5
    Enemy rolled 3
    You strike first
    You rolled a 4 and passed the Dexterity check. You did 7 damage
    Enemy has died
    Combat ended
    """
...
def opponent_one_attack(opponent_one, opponent_two):
    ...
    >>> random.seed(1)
    >>> opponent_one_attack({'Name': 'Jaki', 'Class': 'fighter', 'HP': 9, 'Strength': 18, 'Dexterity': 18,\
                            'Constitution': 18, 'Intelligence': 18, 'Wisdom': 18, 'Charisma': 18, 'XP': 0}\
                     , {'Name': 'Kurisu', 'Class': 'bard', 'HP': 2, 'Strength': 3, 'Dexterity': 3, 'Constitution': 3,\
                        'Intelligence': 3, 'Wisdom': 3, 'Charisma': 3, 'XP': 0})
    You rolled a 5 and passed the Dexterity check. You did 2 damage
    Enemy has died
    0
    >>> opponent_one_attack({'Name': 'Jaki', 'Class': 'fighter', 'HP': 9, 'Strength': 18, 'Dexterity': 18,\
                            'Constitution': 18, 'Intelligence': 18, 'Wisdom': 18, 'Charisma': 18, 'XP': 0}\
                    , {'Name': 'Kurisu', 'Class': 'bard', 'HP': 6, 'Strength': 3, 'Dexterity': 3, 'Constitution': 3,\
                        'Intelligence': 3, 'Wisdom': 3, 'Charisma': 3, 'XP': 0})
    You rolled a 13 and passed the Dexterity check. You did 4 damage
    Enemy now has 2 HP
    """
...
def opponent_two_attack(opponent_one, opponent_two):
    ...
    >>> random.seed(1)
    >>> opponent_two_attack({'Name': 'Jaki', 'Class': 'fighter', 'HP': 9, 'Strength': 18, 'Dexterity': 18,\
                           'Constitution': 18, 'Intelligence': 18, 'Wisdom': 18, 'Charisma': 18, 'XP': 0}\
                     , {'Name': 'Kurisu', 'Class': 'bard', 'HP': 2, 'Strength': 3, 'Dexterity': 3, 'Constitution': 3,\
                        'Intelligence': 3, 'Wisdom': 3, 'Charisma': 3, 'XP': 0})
    Enemy rolled a 5 and failed the Dexterity check
    >>> opponent_two_attack({'Name': 'Jaki', 'Class': 'fighter', 'HP': 9, 'Strength': 18, 'Dexterity': 2,\
                             'Constitution': 18, 'Intelligence': 18, 'Wisdom': 18, 'Charisma': 18, 'XP': 0}\
                     , {'Name': 'Kurisu', 'Class': 'bard', 'HP': 6, 'Strength': 3, 'Dexterity': 3, 'Constitution': 3,\
                        'Intelligence': 3, 'Wisdom': 3, 'Charisma': 3, 'XP': 0})
    Enemy rolled a 3 and passed the Dexterity check. They did 8 damage
    You now have 1 HP
    """
